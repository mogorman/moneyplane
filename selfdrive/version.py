...
def get_comma_remote() -> bool:
  ...
  return origin.startswith('git@github.com:mogorman') or origin.startswith('https://github.com/mogorman')
    ...
    if not get_prebuilt():
      ...
      if dirty and get_comma_remote():
        try:
          ...
          cloudlog.event("dirty mog branch", version=get_version(), dirty=dirty, origin=origin, branch=branch,
