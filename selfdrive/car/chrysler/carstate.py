...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.steerFaultPermanent =  cp.vl["EPS_STATUS"]["LKAS_STEER_FAULT"]  == 1 or (min_steer_check and not cp.vl["EPS_STATUS"]["LKAS_ACTIVE"] and ret.vEgo > self.CP.minSteerSpeed)
